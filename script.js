...
const gameData = {
    agents: [
        { 
            name: "Jett", 
            image: "jett.png", 
            quotes: ["Let's go!", "Up we go!", "Let's get moving!"], 
        ...
        { 
            name: "Phoenix", 
            image: "phoenix.png", 
            quotes: ["Hot hands!", "Feel the heat!", "I'm on fire!"], 
        ...
        { 
            name: "Sage", 
            image: "sage.png", 
            quotes: ["Healing you now.", "I will protect you.", "Stay together!"], 
        ...
        { 
            name: "Sova", 
            image: "sova.png", 
            quotes: ["I have the shot.", "Recon bolt out!", "Enemy spotted!"], 
        ...
        { 
            name: "Brimstone", 
            image: "brimstone.png", 
            quotes: ["Orbital strike incoming!", "Fire in the hole!", "Covering fire!"], 
            bio: "قائد دعم جوي",
        ...
        { 
            name: "Cypher", 
            image: "cypher.png", 
            quotes: ["I see you.", "Trap wire set.", "Camera watching."], 
...
function generateQuestion() {
    ...
    elements.gameContainer.classList.remove('agent-question', 'map-question');
...
function showLevelUp() {
    ...
    levelUpDiv.innerHTML = `
        <div class="level-up-content">
            ...
            <p class="difficulty-info">الصعوبة: ${getDifficultyInfo()}</p>
        </div>
    `;
...
function startTimer() {
    window.timerInterval = setInterval(() => {
        ...
        if (gameData.timer <= 5) {
            elements.timer.style.color = '#ff4655';
